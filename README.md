...
本项目以 [MIT License](./LICENSE) 公开开源，当前仍是开发中的 MVP 基线。公开仓库不代表真实 Provider、生产部署或广告效果已经完成验证，具体能力边界以本文的“当前实现”和 `HANDOFF.md` 为准。

欢迎通过 Issue 提交问题、需求和设计讨论，也欢迎通过 Pull Request 参与共建。提交代码、示例素材或运行记录前，请确认不包含真实 API Key、账号凭据、用户素材、个人信息或未经授权的第三方内容。
